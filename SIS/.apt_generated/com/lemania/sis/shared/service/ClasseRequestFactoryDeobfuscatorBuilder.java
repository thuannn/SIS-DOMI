...
@GwtIncompatible("Server-side only but loaded through naming convention so must be in same package as shared ClasseRequestFactory interface")
...
withOperation(new OperationKey("v7zerD4jireh9YguK$k3B7zzR1s="),
  ...
  .withDomainMethodDescriptor("(Lcom/lemania/sis/server/Classe;)V")
  .withMethodName("save")
...
withOperation(new OperationKey("eyF_jTxtODWQfshRM3S92zobZOE="),
  ...
  .withDomainMethodDescriptor("(Lcom/lemania/sis/server/Classe;Ljava/lang/String;)V")
  .withMethodName("save")
  .withRequestContext("com.lemania.sis.shared.service.ClasseRequestFactory$ClasseRequestContext")
  .build());
...
withOperation(new OperationKey("qQk$r3sTeAEe7mhBicsUYdskhB8="),
  new OperationData.Builder()
  .withClientMethodDescriptor("(Lcom/lemania/sis/shared/ClasseProxy;)Lcom/google/web/bindery/requestfactory/shared/Request;")
  .withDomainMethodDescriptor("(Lcom/lemania/sis/server/Classe;)Lcom/lemania/sis/server/Classe;")
...
withClientToDomainMappings("com.lemania.sis.server.Classe", Arrays.asList("com.lemania.sis.shared.ClasseProxy"));
}}
